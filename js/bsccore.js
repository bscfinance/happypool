...
const LPTokenAddress = '0x352CbB902b223777d68Bfc67AFB711fB7e7128f2';
...
const wethAddress = '0x6fd7c98458a943f469e1cf4ea85b173f5cd342f4';
const routerAddress = '0x125dcf14bb8d508547bd323f523ee7968956272c';
...
async function loadSummary() {
  ...
  var lpStaked = web3.utils.fromWei(
    (await vault.methods.userInfo('2', address).call()).amount
  );
...
async function loadTVaultData() {
  ...
  var pendingBsc = await vault.methods.pendingBsc('2', address).call();
  ...
  var amountStaked = (await vault.methods.userInfo('2', address).call()).amount;
...
async function claimLPV1() {
  ...
  const claim = await new Promise((resolve, reject) => {
    vault.methods.deposit('2', '2').send(
      {
        from: address,
      },
      function (error, transactionHash) {
...
async function withdrawAllLPV1() {
  ...
  const withdraw = await new Promise((resolve, reject) => {
    vault.methods.withdraw('2', amountStaked).send(
      {
        from: address,
      },
      function (error, transactionHash) {
...
async function stakeLPV2() {
  ...
  const deposit = await new Promise((resolve, reject) => {
    vault.methods.deposit('2', web3.utils.toWei(amount, 'ether')).send(
      {
        from: address,
      },
      function (error, transactionHash) {
...
async function stakeAllLPV2() {
  ...
  const deposit = await new Promise((resolve, reject) => {
    vault.methods.depositAll('2').send(
      {
        from: address,
      },
      function (error, transactionHash) {
...
async function withdrawAllLPV2() {
  ...
  const withdraw = await new Promise((resolve, reject) => {
    vault.methods.withdrawAll('2').send(
      {
        from: address,
      },
      function (error, transactionHash) {
